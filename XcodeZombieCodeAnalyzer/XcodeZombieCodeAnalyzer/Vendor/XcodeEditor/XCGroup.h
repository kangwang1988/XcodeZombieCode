...
/**
 * Represents a _group container in an Xcode project. A group can contain
 * members of type `XCSourceFile` or other groups.
 */
...
/**
 * The alias of the group, which can be used to give the group a name other than
...
@property(nonatomic, strong, readonly)
    NSMutableArray<id<XcodeGroupMember>> *children;
...
/**
 * Adds a class to the _group, as specified by the ClassDefinition. If the
 * _group already contains a class by the same
 * name, the contents will be updated.
 */
- (void)addClass:(XCClassDefinition *)classDefinition;

/**
 * Adds a class to the _group, making it a member of the specified
 * [targets](XCTarget).
 */
- (void)addClass:(XCClassDefinition *)classDefinition
...
/**
 * Adds a framework to the _group. If the _group already contains the framework,
 * the contents will be updated if the
 * framework definition's copyToDestination flag is yes, otherwise it will be
 * ignored.
 */
...
/**
 * Adds a _group with an alias to this _group and a particular type (only
 * PBXGroupType and PBXVariantGroupType are valid)
 */
- (XCGroup *)addGroupWithAlias:(NSString *)alias
 ...
 */
- (XCSourceFile *)addFramework:(XCFrameworkDefinition *)framework
                     toTargets:(NSArray<XCTarget *> *)targets;
...
/**
 * Adds a xib file to the _group. If the _group already contains a class by the
 * same name, the contents will be updated.
 */
- (void)addXib:(XCXibDefinition *)xibDefinition;

/**
 * Adds a xib to the _group, making it a member of the specified
 * [targets](XCTarget).
 */
- (void)addXib:(XCXibDefinition *)xibDefinition
     toTargets:(NSArray<XCTarget *> *)targets;
...
/**
 * Adds a sub-project to the _group. If the _group already contains a
 * sub-project by the same name, the contents will be
 * updated.
 * Returns boolean success/fail; if method fails, caller should assume that
 * project file is corrupt (or file format has
 * changed).
 */
- (void)addSubProject:(XCSubProjectDefinition *)projectDefinition;

/**
 * Adds a sub-project to the _group, making it a member of the specified
 * [targets](XCTarget).
 */
- (void)addSubProject:(XCSubProjectDefinition *)projectDefinition
            toTargets:(NSArray<XCTarget *> *)targets;
...
- (void)removeSubProject:(XCSubProjectDefinition *)projectDefinition
             fromTargets:(NSArray<XCTarget *> *)targets;

#pragma mark Locating children
/**
 * Instances of `XCSourceFile` and `XCGroup` returned as the type
 * `XcodeGroupMember`.
 */
