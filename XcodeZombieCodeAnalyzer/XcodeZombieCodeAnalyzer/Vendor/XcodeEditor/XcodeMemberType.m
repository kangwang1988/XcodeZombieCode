...
- (BOOL)xce_hasFileReferenceOrReferenceProxyType {
  return [self isEqualToString:kPBXFileReference] ||
         [self isEqualToString:kPBXReferenceProxy];
}
...
- (BOOL)xce_hasGroupType {
  return [self isEqualToString:kPBXGroup] ||
         [self isEqualToString:kPBXVariantGroup];
}
...
- (BOOL)xce_hasSourcesOrFrameworksBuildPhaseType {
  return [self isEqualToString:kPBXSourcesBuildPhase] ||
         [self isEqualToString:kPBXFrameworksBuildPhase];
}
